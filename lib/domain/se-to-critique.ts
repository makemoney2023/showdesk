...
/**
 * Reports / print: this appearance's own critique only.
 * Friday SE, Saturday, and Sunday each keep their own letter. A pasted SE
 * narrative on Sunday must not become Saturday's certificate.
 */
